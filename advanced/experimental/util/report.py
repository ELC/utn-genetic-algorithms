...
from experimental.util.graphic import graphics
import experimental.population as Population
import experimental.controller
...
class Report():
    ...
    def write_csv(cls, df, execution_time):
        ...
        filename = "experimental/results/" + name + '.csv'
    ...
    def write_excel(cls, df, execution_time):
        ...
        filename = 'experimental/results/resultados.xlsx'
    ...
    def graphic_min_max_mean(cls):
        data = FileManager.load_results()
        maximums, _, averages, *_ = cls._get_array_data(data)
        graphics(datas=(maximums, averages),
